...
End If
        ...
        RSave.EDIT
            ...
            RSave("NO_KTP") = Trim(Text4)
            RSave("TELP") = Trim(Text6)
            RSave("TGL_LAHIR") = Format(Text17, "MM/DD/YYYY")
        RSave.Update
        RSave.Close
        Set RSave = Nothing
...
If RToket.RowCount <> 0 Then
    ...
    Text18 = Format(RToket("NO_KTP"), ">")
    Text6 = Format(RToket("TELP"), ">")
    Text17 = RToket("TGL_LAHIR")
