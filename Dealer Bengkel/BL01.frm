...
Dim Tanya
Tanya = MsgBox("CETAK VALIDASI", vbOKCancel, "KONFIRMASI")
    If Tanya = vbOK Then
        ...
        Printer.Print Tab(5); ""
        Printer.Print Tab(5); ""
        Printer.Print Tab(5); Label10
        Printer.Print Tab(5); "No.Trans."; Spc(3); Label3
        Printer.Print Tab(5); "No.Fak."; Spc(5); Text1
        Printer.Print Tab(6); ""
        Printer.Print Tab(6); "TOTAL."; Spc(5); Text8
        Printer.EndDoc
    Else
        Exit Sub
    End If
...
'INFO HARGA JUAL PCS'
    ...
    JMLBRG = JMLBRG - 1
        ...
        Set RCari14 = RDCO.OpenResultset(SCari14, rdOpenKeyset, rdConcurRowVer)
            ...
            RCari14("HARGA_BELI") = RCari12("HARGA_PCS")
...
If Text10 = "" Then Exit Sub
    If Not IsNumeric(Text10) Then
        MsgBox "MENGGUNAKAN DALAM FORMAT ANGKA", vbCritical, "TYPE DATA SALAH"
        Text10.SetFocus
    Exit Sub
End If
