...
crpt.ReportFileName = App.Path + "\ReportD\B003.rpt"
...
Private Sub IsiGol()
Dim KodeG
SGol = "Select Kode_IND From B001 order by Kode_Ind"
Set RGol = RDCO.OpenResultset(SGol, rdOpenDynamic, rdConcurRowVer)
If RGol.RowCount <> 0 Then
    RGol.MoveFirst
...
If Not IsNumeric(Text4) Then
    Text4.SetFocus
    MsgBox "NOMINAL HARGA BELI MENGGUNAKAN ANGKA", vbCritical, "TYPE DATA SALAH"
    Text4 = 0
    Exit Sub
End If
...
If Not IsNumeric(Text6) Then
    Text6.SetFocus
    MsgBox "NOMINAL HARGA JUAL MENGGUNAKAN ANGKA", vbCritical, "TYPE DATA SALAH"
    Text6 = 0
    Exit Sub
End If
...
If Text7 = "" Then Text7.SetFocus
If Not IsNumeric(Text7) Then
    Text7.SetFocus
    MsgBox "NOMINAL HARGA KOSONG MENGGUNAKAN ANGKA", vbCritical, "TYPE DATA SALAH"
    Text7 = 0
    Exit Sub
End If
...
Private Sub IsiGrid()
SCari = "Select * from B003 order by Kode_Jns"
...
Do Until RCari.EOF
    ...
    If RCari("Kode_Ind") = 151 Then
        WARNA = &HFFFFFF
    ElseIf RCari("Kode_Ind") = 152 Then
        WARNA = &HC0C0FF
    ElseIf RCari("Kode_Ind") = 153 Then
        WARNA = &HFFFF&
    End If
        
        .Col = 0: .Text = RCari("Kode_Ind"): .CellAlignment = 4: .CellBackColor = WARNA
        .Col = 1: .Text = RCari("Kode_Jns"): .CellAlignment = 4
...
With Grid
     ...
     .Col = 3: .ColWidth(3) = 1000: .Text = "STYLE": .CellAlignment = 4
     .Col = 4: .ColWidth(4) = 1000: .Text = "WARNA": .CellAlignment = 4
     .Col = 5: .ColWidth(5) = 1500: .Text = "SATUAN": .CellAlignment = 4
End With
End Sub
