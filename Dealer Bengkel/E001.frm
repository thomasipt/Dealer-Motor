...
SCari = "Select * from M001 where STS_JUAL = '1'"
Set RCari = RDCO.OpenResultset(SCari, rdOpenDynamic, rdConcurRowVer)
Do Until RCari.EOF
    RCari.EDIT
        RCari("TELP") = "------"
        RCari("NO_KTP") = "------"
        RCari("TGL_LAHIR") = "01/01/2000"
    RCari.Update
RCari.MoveNext
Loop
RCari.Close
...
If DateValue(Text1) < DateValue(Label5) Then
    Text1.SetFocus
    MsgBox "TANGGAL AKHIR MENGGUNAKAN LEBIH BESAR atau SAMA DENGAN TANGGAL AWAL", vbCritical, "TANGGAL AKHIR TIDAK BOLEH LEBIH BESAR"
    Exit Sub
End If
