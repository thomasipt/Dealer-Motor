...
Public CN As String
Public NO_FAKTUR, OYEN, STS_Nama, STS_Mesin, STS_Rangka, STS_Biaya, NamaHutang, NoHutang, TBACKUP, KRK, Status, NoUrut, NoPinjaman, No_Nas, Nama_Nas, NO_RANGKA, JML_UNIT, FAKTUR, TANGGAL_FAKTUR, G_DEBET, G_CREDIT, F_DEBET, F_CREDIT, N_ALAMAT, N_CCAB, KodeBR, NamaBR, K, BR, KB, Tanggal, CodeCab, Operator, CodeBag, gdebet, GCredit, MutasiD, MutasiC, Skin, NToko, NAlamat, NMOtto, NTelepon As String

Sub Main()
CN = "DSN=DEALER;DRIVER={Microsoft Access Driver};Server=CENTRAL;UID= ;PWD= ;Database = DEALER.mdb;"
LOGIN.Show
End Sub
