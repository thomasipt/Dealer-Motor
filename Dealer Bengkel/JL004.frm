...
If Not IsDate(Text1) Then
    Text1.SetFocus
    Text1 = Tanggal
    MsgBox "TANGGAL MENGGUNAKAN TYPE TANGGAL", vbCritical, "TYPE DATA SALAH"
End If
...
If Not IsDate(Text17) Then
    Text17.SetFocus
    Text17 = Tanggal
    MsgBox "TANGGAL LAHIR MENGGUNAKAN TYPE TANGGAL", vbCritical, "TYPE DATA SALAH"
End If
Text17 = Format(Text17, "DD/MM/YYYY")
End Sub
...
If Not IsNumeric(Text2) Then
    Text2.SetFocus
    MsgBox "NOMINAL INTENSIF MENGGUNAKAN ANGKA", vbCritical, "TYPE DATA SALAH"
    Exit Sub
End If
...
If Not IsDate(Text21) Then
    Text21.SetFocus
    Text21 = Tanggal
    MsgBox "TANGGAL MULAI KREDIT MENGGUNAKAN TYPE TANGGAL", vbCritical, "TYPE DATA SALAH"
End If
...
RJual.EDIT
    ...
    RJual("NO_KTP") = Trim(Text4)
    RJual("TELP") = Trim(Text6)
    RJual("TGL_LAHIR") = Text17
