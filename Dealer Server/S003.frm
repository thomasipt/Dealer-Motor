...
OYEN = "Select Top 10 NAMA, ALAMAT, TELEPON, NO_POL, NO_RANGKA, NO_MESIN, TIPE from S003"
Call IsiGridInfo
...
If Text11 = "" Then Text11.SetFocus
    ...
    If Not IsNumeric(Text11) Then
        Text11.SetFocus
        Text11 = ""
        MsgBox "DISKON (%) HARUS ANGKA", vbCritical, "TYPE DATA SALAH"
        Exit Sub
    End If
...
End If
    ...
    Label16 = "KEMBALIAN"
    Text12 = Format(CCur(Text15) - CCur(Text16), "##,###.00")
    
    If CCur(Text15) < CCur(Text16) Then
        Label16 = "TOTAL BAYAR"
        Text12 = Format(CCur(Text16), "##,###.00")
        Text15.SetFocus
        Text15 = ""
